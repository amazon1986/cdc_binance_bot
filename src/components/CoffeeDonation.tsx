        ...
        <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-lg space-y-3">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              ขอขอบคุณทุกท่านที่ให้ความสนใจและใช้งาน <strong>CDC Action Zone Binance Trading Bot</strong> หวังเป็นอย่างยิ่งว่าเครื่องมือนี้จะมีประโยชน์ต่อการเทรดของท่าน ทุกกำลังใจและทุกการสนับสนุนของท่านจะนำไปพัฒนาอัปเกรดระบบให้มีความแม่นยำ เสถียร และปลอดภัยยิ่งขึ้นต่อไปครับ 🙏
            </p>
